        ...
        for app in context['available_apps']:
            ...
            for model in app['models']:
                ...
                if app['name'] == 'Hospital': 
                    ...
                    style         ="style=background-color:#007bff;color:white;"
                if(request.path == url):
                    r += '<li class="nav-item"><a href="%s" class="nav-link active" %s>%s %s</a></li>' % (url,style, icon, model['name'])
                else:
