...
from .admin_view import vehicle_soft_delete,hospital_soft_delete,category_soft_delete,vendoruser_soft_delete,vehicle_save
...
class MyAdminSite(admin.AdminSite):
    ...
    def get_urls(self):
        ...
        my_urls = [
            ...
            url('^hospital/hospital/delete_hospital_user/$',
                self.admin_view(hospital_soft_delete)),
